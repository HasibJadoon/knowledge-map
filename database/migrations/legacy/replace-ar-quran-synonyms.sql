--------------------------------------------------------------------------------
-- Replace ar_quran synonym tables with normalized 2-table schema
--------------------------------------------------------------------------------

DROP TABLE IF EXISTS ar_quran_synonym_topic_words;
DROP TABLE IF EXISTS ar_quran_synonym_words;
DROP TABLE IF EXISTS ar_quran_synonym_topics;
