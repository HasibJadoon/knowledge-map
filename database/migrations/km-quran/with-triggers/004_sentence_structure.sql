...
CREATE TRIGGER trg_qr_ss_occ_sentence_updated_at
AFTER UPDATE ON qr_ss_occ_sentence
FOR EACH ROW WHEN NEW.updated_at IS OLD.updated_at
BEGIN UPDATE qr_ss_occ_sentence SET updated_at = datetime('now') WHERE id = OLD.id; END;
