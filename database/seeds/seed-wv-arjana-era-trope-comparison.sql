...
INSERT OR REPLACE INTO wv_comparison_cells (id,comparison_id,row_id,axis_id,cell_text,stance,meta_json) VALUES
  ...
  ('wv-ccell-sexualization-medieval','wv-cmp-arjana-era-trope','wv-crow-arjana-sexualization','wv-cax-arjana-medieval','1','intensity-1',json('{"intensity":1}')),
  ...
  ('wv-ccell-sexualization-sept11','wv-cmp-arjana-era-trope','wv-crow-arjana-sexualization','wv-cax-arjana-sept11','1','intensity-1',json('{"intensity":1}')),
