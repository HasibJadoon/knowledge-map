...
INSERT OR REPLACE INTO wv_comparison_cells (id,comparison_id,row_id,axis_id,cell_text,stance,meta_json) VALUES
  ...
  ('wv-ccell-dehumanization-medieval','wv-cmp-arjana-era-trope','wv-crow-arjana-dehumanization','wv-cax-arjana-medieval','3','intensity-3',json('{"intensity":3}')),
  ...
  ('wv-ccell-race-medieval','wv-cmp-arjana-era-trope','wv-crow-arjana-race','wv-cax-arjana-medieval','3','intensity-3',json('{"intensity":3}')),
  ('wv-ccell-race-renaissance','wv-cmp-arjana-era-trope','wv-crow-arjana-race','wv-cax-arjana-renaissance','2','intensity-2',json('{"intensity":2}')),
  ...
  ('wv-ccell-gender-renaissance','wv-cmp-arjana-era-trope','wv-crow-arjana-gender','wv-cax-arjana-renaissance','2','intensity-2',json('{"intensity":2}')),
