...
INSERT OR REPLACE INTO qr_morph_display_blocks
 ...
 VALUES ('MDB:root:كتب:occurrences', 'root', 'كتب', 'كتب', '44:2', 44, 2, 1,
  ...
  'يردُ الجذرُ نحوَ ٣١٩ مرّةً بمعانٍ متضامّة: الوحيُ المنزَّل، والفَرْضُ المقضيّ، وسِجِلُّ الأعمال، والرسالةُ المكتوبة. وموضعُ الدراسة هنا: ﴿وَالْكِتَابِ الْمُبِينِ﴾.', 'The root occurs ~319 times across kindred senses — revealed Scripture, settled decree, the record of deeds, a written letter. The study locus here is ﴿وَالْكِتَابِ الْمُبِينِ﴾.', 'جڑ تقریباً ۳۱۹ بار: وحی، فرض، اعمال نامہ، خط۔ مطالعہ: ﴿وَالْکِتَابِ الْمُبِینِ﴾۔', '{"items":[{"ayah_key":"44:2","kind_ar":"الكتاب المبين","en":"the clear Book","motif":"revelation","text_ar":"وَالْكِتَابِ الْمُبِينِ","note":"القرآنُ المُقسَمُ به، الموصوفُ بالإبانة","note_en":"The Qurʾān sworn by, described as self-evidencing (mubīn).","focus":true,"icon":"star"},{"ayah_key":"17:14","kind_ar":"كتابُ الأعمال","en":"the record of deeds","motif":"split","text_ar":"اقْرَأْ كِتَابَكَ","note":"صحيفةُ العمل التي كتبها الحفَظة، يقرؤها المرءُ على نفسه","note_en":"The deed-scroll the recording angels wrote; one reads it against oneself.","icon":"quote"},{"ayah_key":"27:28","kind_ar":"كتابُ سليمان","en":"a written letter","motif":"arrival","text_ar":"اذْهَب بِّكِتَابِي هَٰذَا","note":"رسالةٌ مكتوبة أرسلها سليمانُ إلى ملكة سبأ","note_en":"A written missive Solomon sent to the Queen of Sheba.","icon":"feather"},{"ayah_key":"13:39","kind_ar":"أمُّ الكتاب","en":"the archetype/decree","motif":"shape","text_ar":"وَعِندَهُ أُمُّ الْكِتَابِ","note":"أصلُ الكتاب وجملتُه عند الله — الثابتُ الذي عليه المحوُ والإثبات","note_en":"The origin and whole of the Book with God — the fixed source over which erasing and fixing occur.","icon":"key-round"}]}', NULL, 0, 'quran', '["quran"]', '{"icon":"map-pin"}', 'live');
...
INSERT OR REPLACE INTO qr_morph_display_blocks
 ...
 VALUES ('MDB:root:كتب:master_story', 'root', 'كتب', 'كتب', '44:2', 44, 2, 1,
  ...
  'قصةُ (كتاب) في أربع حركات: الضمُّ، فالخطُّ، فالفَرْضُ، فالكتابُ المُبين.', 'The story of كِتاب in four movements: binding, then writing, then decreeing, then the Book made manifest.', 'کتاب کی کہانی چار حرکتوں میں۔', '{"medallion_ar":"كِتاب","medallion_root":"ك ت ب","threads":["المعجم","الاشتقاق","التفسير"],"movements":[{"no":"I","motif":"binding","en":"The Binding","ar":"الضمّ","accent":"#c9a84c","text":"كان الكَتْبُ أوّلَ أمرِه ==ضمًّا محسوساً==: خَرْزُ الأديمِ يُلحِمُ طرَفاً بطرَف، وجمعُ الكَتيبةِ يشُدُّ الصفَّ إلى الصفّ. فكلُّ ما جُمِعَ وضُمَّ فقد كُتِبَ — وهو أصلُ ابنِ فارسٍ الواحد: الجمعُ والضمّ.","text_en":"At first كَتْب was a ==binding you could touch==: stitching hide so edge fuses to edge, mustering a battalion so rank locks to rank. Whatever was gathered and joined was “written” — Ibn Fāris’s one root sense: gathering and binding.","icon":"link","chips":[{"ar":"كَتيبة","en":"battalion"}]},{"no":"II","motif":"writing","en":"The Writing","ar":"الخطّ","accent":"#7fb58f","text":"ثم انتقلَ الضمُّ من الأشياءِ إلى ==الحروف==: ضُمَّ حرفٌ إلى حرفٍ بالخطِّ فانعقدَ اللفظُ والمعنى، ونشأتْ أسرةُ الكتابة — الكاتبُ يخُطّ، والمكتوبُ يَثبُت، والكِتابةُ صناعةً. فصار الجمعُ الحسّيُّ جمعاً يحفظُ الكلامَ من الضياع.","text_en":"Then the binding moved from things to ==letters==: sign joined to sign by the pen until word and meaning set, and the family of writing was born — the scribe who inscribes, the written that endures, writing as a craft. The tangible gathering became one that saves speech from loss.","icon":"feather","chips":[{"ar":"كاتِب","en":"scribe"}]},{"no":"III","motif":"decree","en":"The Decree","ar":"الفَرْض","accent":"#8878e2","text":"وما أُثبِتَ بالخطِّ لا يُمحى، فاستُعيرَ الكَتْبُ ==للحُكمِ الماضي==: ﴿كُتِبَ عليكم الصيام﴾ أي فُرِضَ وأُلزِم، وكَتَبَ اللهُ الشيءَ: قضاه وقدَّره. هكذا رتَّبَ الراغبُ المعنى من ضمِّ الحروفِ إلى الفَرْض، وأبرزَ ابنُ منظورٍ دلالةَ القَدَرِ والقضاء.","text_en":"What the pen fixes is not erased, so كَتْب was borrowed for the ==binding decree==: “kutiba ʿalaykum” — it is prescribed, made binding; “God wrote the thing” — He decreed it. Al-Rāghib ordered the sense from joining letters to prescribing, and Ibn Manẓūr foregrounded fate and decree.","icon":"key-round","chips":[{"ar":"كُتِبَ عليكم","en":"prescribed"}]},{"no":"IV","motif":"scripture","en":"The Book Made Manifest","ar":"الكتاب المبين","accent":"#93b8d6","text":"وبلغَ الجذرُ ذروتَه في القرآن: ==كِتابٌ منزَّلٌ== يجمعُ الحرفَ والحُكمَ والوعدَ في وحيٍ واحد، أُقسِمَ به على نزولِه في ليلةٍ مباركة، ووُصِفَ بالمُبينِ لأنه بيِّنٌ في نفسِه مُبيِّنٌ لغيره. فالكتابُ المبينُ عند الزمخشريِّ هو القرآن — غايةُ ما ضُمَّ وأُثبِتَ ثم أبان.","text_en":"In the Qurʾān the root reaches its summit: a ==Book sent down== that binds letter, decree and promise into one revelation, sworn by upon its descent on a blessed night, and called mubīn — clear in itself, clarifying for others. For al-Zamakhsharī the clarifying Book is the Qurʾān: the utmost of what was bound and fixed, then made plain.","icon":"book-open","chips":[{"ar":"المبين","en":"clear"}]}]}', 'kmaps_master_story', 1, 'linguistic', '["linguistic","tafsir"]', '{"icon":"sparkles"}', 'live');
