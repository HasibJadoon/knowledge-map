...
INSERT OR REPLACE INTO qr_morph_display_blocks
 ...
 VALUES ('MDB:root:كتب:master_story', 'root', 'كتب', 'كتب', '44:2', 44, 2, 1,
  ...
  'قصةُ (كتاب) في أربع حركات: الضمُّ، فالخطُّ، فالفَرْضُ، فالكتابُ المُبين.', 'The story of كِتاب in four movements: binding, then writing, then decreeing, then the Book made manifest.', 'کتاب کی کہانی چار حرکتوں میں۔', '{"medallion_ar":"كِتاب","medallion_root":"ك ت ب","threads":["المعجم","الاشتقاق","التفسير"],"movements":[{"no":"I","motif":"binding","en":"The Binding","ar":"الضمّ","accent":"#c9a84c","text":"في الأصلِ ضمٌّ: خرزُ الأديم، وجمعُ الكَتيبة — كلُّ ما جُمِعَ وضُمَّ.","text_en":"At root, a binding: stitching hide, massing a battalion — all that is gathered and joined.","icon":"link","chips":[{"ar":"كَتيبة","en":"battalion"}]},{"no":"II","motif":"writing","en":"The Writing","ar":"الخطّ","accent":"#7fb58f","text":"ثم ضُمَّت الحروفُ بالخطّ، فكان الكاتبُ والمكتوبُ والكِتابة.","text_en":"Then letters were bound by the pen — so came the scribe, the written, and the craft of writing.","icon":"feather","chips":[{"ar":"كاتِب","en":"scribe"}]},{"no":"III","motif":"decree","en":"The Decree","ar":"الفَرْض","accent":"#8878e2","text":"وما أُثبِتَ بالكتابةِ لا يُمحى، فصار كُتِبَ بمعنى فُرِضَ وقُضِيَ.","text_en":"What the pen fixes cannot be unwritten, so كُتِبَ came to mean “decreed, ordained.”","icon":"key-round","chips":[{"ar":"كُتِبَ عليكم","en":"prescribed"}]},{"no":"IV","motif":"scripture","en":"The Book Made Manifest","ar":"الكتاب المبين","accent":"#93b8d6","text":"وبلغَ الجذرُ ذروتَه: كِتابٌ منزَّلٌ مُبينٌ، أُقسِمَ به على نزوله في ليلةٍ مباركة.","text_en":"And the root reached its summit: a Book sent down and made clear, sworn by upon its descent on a blessed night.","icon":"book-open","chips":[{"ar":"المبين","en":"clear"}]}]}', 'kmaps_master_story', 1, 'linguistic', '["linguistic","tafsir"]', '{"icon":"sparkles"}', 'live');
