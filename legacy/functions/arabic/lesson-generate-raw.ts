...
import {
  QuranLessonMetadataSchema,
  QuranLessonSentencesSchema,
  QuranLessonPassageLayerSchema,
  QuranLessonReflectiveAnalyticalSchema,
  QuranLessonMCQSchema,
} from "../schemas/quranLesson.schema";
...
const passDefinitions = [
  {
    name: "metadata",
    schema: QuranLessonMetadataSchema,
  ...
  {
    name: "sentences",
    schema: QuranLessonSentencesSchema,
  ...
  {
    name: "passage_layers",
    schema: QuranLessonPassageLayerSchema,
  ...
  },
  {
    ...
    schema: QuranLessonReflectiveAnalyticalSchema,
