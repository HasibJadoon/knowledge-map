...
export const QuranLessonMetadataSchema = createSchema({ requiredFields: [] });
export const QuranLessonSentencesSchema = createSchema({
  requiredFields: ["sentences"],
});
export const QuranLessonPassageLayerSchema = createSchema({
  requiredFields: ["passage_layers"],
});
export const QuranLessonReflectiveAnalyticalSchema = createSchema({
  requiredFields: [],
  comprehensionFragment: reflectiveAnalyticalFragment,
});
export const QuranLessonMCQSchema = createSchema({
  requiredFields: [],
  comprehensionFragment: mcqFragment,
});
export const QuranLessonSchema = createSchema({
