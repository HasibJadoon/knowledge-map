...
/**
 * Per-ayah-group iʿrāb reader. Consumes /qr/iraab/display?surah=N&ayah=M and
 * renders blocks grouped by source. Each source's blocks are ordered by
 * display_order, naturally producing the section flow:
 *   heading(irab) → irab_card×N → heading(sarf) → sarf_note×N → balagha … → fawaid …
 */
@Component({
  selector: 'app-iraab-display-page',
  standalone: true,
  imports: [CommonModule, IonicModule, DisplayBlockComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './iraab-display.page.html',
  styleUrl: './iraab-display.page.scss',
})
