...
import { TargetedNotesApiService } from '../../targeting/targeted-notes-api.service';
import { CaptureNote, TargetRef, computeTitleFromMarkdown } from '../../targeting/targeting.models';
