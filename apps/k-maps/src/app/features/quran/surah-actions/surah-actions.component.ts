...
const SVG = {
  ...
  vocabulary: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ${S}>
...
const ACTIONS: ActionIconVm[] = [
  ...
  { id: 'vocabulary', label: 'Vocab',  svgPath: SVG.vocabulary, ariaLabel: 'Vocabulary of this surah',       color: '#C084F5' }, // bright purple
