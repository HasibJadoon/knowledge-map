...
export interface SynthesisData { output?: string; strands?: SynthesisStrand[]; }
...
export interface OccurrenceItem {
  ayah_key: string; kind_ar: string; en: string; text_ar: string; note?: string;
...
export interface StoryMovement {
  no: string; motif?: string; en: string; ar: string; accent?: string; text: string;
