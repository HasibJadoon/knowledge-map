...
@Component({
  ...
  templateUrl:     './study-sentence-structure-step.component.html',
  styleUrl:        './study-sentence-structure-step.component.scss',
})
export class StudySentenceStructureStepComponent implements OnChanges {
  ...
  lessonMeta: SsStudyMeta | null = null;
  ...
  get currentMeta(): SsStudyMeta | null {
