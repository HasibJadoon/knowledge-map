...
@Component({
  selector: 'km-study-passage-structure-step',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './study-passage-structure-step.component.html',
  styleUrl: './study-passage-structure-step.component.scss',
})
export class StudyPassageStructureStepComponent implements OnInit, AfterViewInit, OnDestroy {
