...
/**
 * Desktop multi-scholar tafsir reader. Mirrors the Ionic page but uses native
 * HTML + grid layout for the side-by-side scholar columns.
 */
@Component({
  selector: 'km-tafsir-display-page',
  standalone: true,
  imports: [CommonModule, DisplayBlockComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './tafsir-display-page.component.html',
  styleUrl: './tafsir-display-page.component.scss',
})
  ...
  ngOnInit(): void {
    this.route.queryParamMap
      ...
      .subscribe(params => {
        ...
        this.ayah.set(parseInt(params.get('ayah')  ?? '255', 10));
        this.loadPayload();
      });
