...
export const WORLDVIEW_ROUTES: Routes = [
  {
    path: '',
    loadComponent: () =>
      import('./worldview-shell/worldview.component').then((m) => m.WorldviewComponent),
    ...
    children: [
      ...
      },
      {
        path: 'library/:id',
        loadComponent: () =>
          import('./worldview-library-units/worldview-library-units.component').then((m) => m.WorldviewLibraryUnitsComponent),
