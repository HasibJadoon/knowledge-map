...
@Component({
  ...
  styles: [`
    ...
    .wv-illus__head {
      ...
      color: var(--km-text-gold, #c9a84c); font-weight: 700; margin-bottom: .6rem;
    }
    .wv-illus__card {
    ...
    .wv-illus__cap {
      ...
      color: var(--km-text-2, rgba(255,255,255,.55));
      padding: .55rem .85rem; border-top: 1px solid var(--km-border, rgba(255,255,255,.08));
    }
  `],
})
