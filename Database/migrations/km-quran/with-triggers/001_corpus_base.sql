...
CREATE TRIGGER trg_qr_surahs_updated_at
AFTER UPDATE ON qr_surahs
FOR EACH ROW WHEN NEW.updated_at IS OLD.updated_at
BEGIN UPDATE qr_surahs SET updated_at = datetime('now') WHERE id = OLD.id; END;
...
CREATE TRIGGER trg_qr_ayah_updated_at
AFTER UPDATE ON qr_ayah
FOR EACH ROW WHEN NEW.updated_at IS OLD.updated_at
BEGIN UPDATE qr_ayah SET updated_at = datetime('now') WHERE id = OLD.id; END;
