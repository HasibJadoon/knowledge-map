...
export function buildDistillPrompt(context: DistillPromptContext): string {
  ...
  return [
    ...
    '',
    'Your job is to convert reading evidence (highlights and notes) from a passage into structured worldview insights and media-ready content.',
    '',
    'Use ONLY the provided evidence. Do not invent unsupported commentary or external sources.',
    '',
    'Analyze the passage evidence and generate:',
    '1. worldview nodes (concepts or claims)',
    '2. relationships between nodes',
    '3. a study note document summarizing the passage',
    '4. document blocks representing sections of the summary',
    '5. links between blocks and nodes',
    '6. a podcast / YouTube episode outline based on the same insights',
    '',
    'Rules:',
    '- Node titles must be concise.',
    '- Node summaries must be short.',
    ...
    '- Organize document blocks logically.',
    '- The podcast outline must stay grounded in the highlights and notes.',
    ...
    '}',
    '',
    'Use Surah Yusuf 12:1-7 as the structural example: concise nodes, coherent edges, one study note document, sectioned document blocks, node-linked blocks, and a spoken episode outline grounded in the same evidence.',
    '',
    'PASSAGE DATA',
